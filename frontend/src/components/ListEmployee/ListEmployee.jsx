...
import MiChart from "../MiChart/MiChart";
  ...
  return (
    <>
      <div className="border-solid border-2 border-yellow-sandy m-1 p-3 grid grid-cols-3 content-center rounded-md bg-white-sand h-full flex-shrink-0 w-9/12">
        <button
          className="col-span-1 row-span-2 justify-self-center"
          onClick={toggleModal}
        >
          <Profile />
        </button>
        <div className="min-w-0 col-start-2 justify-self-start self-center">
          ...
          {openModalChart && (
            <div className=" w-screen h-screen absolute top-0 left-0 flex inset-0 items-center justify-center z-50">
              ...
              <div className="fixed">
                <div className="flex items-center justify-end">
                  <button onClick={toggleChart} className=" flex  items-center">
                    <CloseIcon />
                  </button>
                </div>
                <div className="bg-blue-calypso p-6 rounded-md shadow-lg flex flex-col items-center justify-center">
        ...
        <div
          onClick={toggleChart}
          className="col-start-3 row-start-1 row-end-3 justify-self-center self-center"
        >
          <ChartIcon />
        </div>
      </div>
