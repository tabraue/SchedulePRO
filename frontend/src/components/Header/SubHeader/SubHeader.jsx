...
function SubHeader() {
  ...
  return (
    <div className="absolute justify-end p-10 my-50 self-center">
    <div className="inline-flex rounded-md shadow-sm self-center" role="group">
      <button
        type="button"
      ...
      <button
        ...
        className="inline-flex items-center px-4 py-2 text-lg font-medium text-green-paradiso bg-white-sand border-t border-b border-gray-200 hover:bg-gray-200 hover:text-green-paradiso focus:z-10 focus:ring-2 focus:ring-green-paradiso focus:text-green-paradiso"
      >
        Add
        <svg
          className="w-10 h-10 mr-12 ml-12"
