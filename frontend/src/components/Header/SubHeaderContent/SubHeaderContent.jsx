  ...
  return (
    <div className="flex flex-row place-items-center w-full">
      ...
      >
        ...
        <div className="inline-flex items-center text-lg font-medium text-green-paradiso bg-white-sand border border-gray-200  hover:text-green-paradiso focus:z-10 focus:ring-2 focus:ring-green-paradiso focus:text-green-paradiso">
          <input
            type="search"
            id="default-search"
