...
function CardDepartment({info}) {
  ...
  return (
    <div className="max-w-sm bg-white-sand border border-green-paradiso rounded-lg shadow ">
      ...
      <div className="p-5">
        <a href="#">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-green-paradiso text-center">
            name
          </h5>
        </a>
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-center hover:text-white hover:bg-green-paradiso rounded-lg bg-white-sand text-green-paradiso focus:ring-4 focus:outline-none focus:ring-green-paradiso ml-auto"
        >
          <svg
